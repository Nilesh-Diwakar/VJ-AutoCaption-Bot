...
try: app_id = int(os.environ.get("app_id", "28377464"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "4d7869d1807d42fa3683f1eee8248697")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7461694036:AAH6fqE0kdUWO5pOZ4uQCMtV_be70ffIlL4" JOIN @Paapiyon_ka_Bot)
...
about_message = """
<b>• Name : <a href=https://t.me/Paapiyon_ka_Bot AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/Paapiyon_ka_Bot>[Movies Updates]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/Paapiyon_ka_Bot>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/Paapiyon_ka_Bot"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/Paapiyon_ka_Bot?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/Paapiyon_ka_Bot")
